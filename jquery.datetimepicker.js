    ...
    $.fn.datetimepicker = function (opt) {
        ...
        createDateTimePicker = function (input) {
            ...
            datetimepicker.setOptions = function (_options) {
                ...
                if (_options.countOnDay) {
                    options.countOnDay = _options.countOnDay;
                }
                ...
                .on('xchange.xdsoft', function (event) {
                    ...
                    xchangeTimer = setTimeout(function () {
                        ...
                        while (i < _xdsoft_datetime.currentTime.countDaysInMonth() || start.getDay() !== options.dayOfWeekStart || _xdsoft_datetime.currentTime.getMonth() === start.getMonth()) {
                            ...
                            var count = 0;
                            if (Object.keys(options.countOnDay).length && ((count = options.countOnDay[y + '-' + (m + 1) + '-' + d]) != undefined)) {
                                count =  options.countOnDay[y + '-' + (m + 1) + '-' + d];
                            }

                            table += '<td data-date="' + d + '" data-month="' + m + '" data-year="' + y + '"' + ' class="xdsoft_date xdsoft_day_of_week' + start.getDay() + ' ' + classes.join(' ') + '">' +
                                '<div>' + (count ? '<small class="xdsoft_count_on_day">(' + count + ')</small> ' : '') + d + '</div>' +
                                '</td>';
